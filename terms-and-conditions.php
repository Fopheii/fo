...
<head>
    ...
    <title>Trems and Conditions - Weeksinyear</title>
    <meta name="Description" content="Trems and Conditions - Weeksinyear" />
...
<body>
    ...
    <div class="container">
        <div class="text-justify pt-5">
            ...
            <h1 class="h1 font-weight-bold mb-4 mt-4" style="font-weight: 800;"><i class="fa fa-handshake"></i> Terms & Conditions</h1>

            <h2 class="terms-h2"><strong>AGREEMENT TO TERMS</strong></h2>
            <p class="mb-3">Please review these terms and conditions of use carefully before using savett.cc. This document states
                the terms and conditions ("Terms") upon which savett.cc ("we" or "us") will provide service to you on
                its websites, including, without limitation, the above listed websites (collectively, the "Website").
                These Terms constitute a contractual agreement between you and us. By visiting, accessing, using, and/or
                joining (collectively "using") the Website, you express your understanding and acceptance of these
                Terms. As used in this document, the terms "you" or "your" refers to you, any entity you represent, your
                or its representatives, successors, assigns and affiliates, and any of your or their devices. <span style="font-weight: 600;">IF YOU DO
                NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU
                MUST CEASE USING the WEBSITE.</span>
            ...
            <h2 class="terms-h2"><strong>USE LICENSE</strong></h2>

            <p class="mb-3">Permission is granted to temporarily download one copy of the materials on savett.cc's website for
                personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of
                title, and under this license you agree not to:
                ...
                any revenue-generating endeavor or commercial enterprise.</p>

            <h2 class="terms-h2"><strong>TERM AND TERMINATION</strong></h2>

            <p class="mb-3">These Terms of Use shall remain in full force and effect while you use the Site.<span style="font-weight: 600;"> WITHOUT LIMITING ANY
            ...
            <h2 class="terms-h2"><strong>ADVERTISERS</strong></h2>

            <p class="mb-3">We allow advertisers to display their advertisements and other information in certain areas of the Site,
                ...
                place such advertisements, and we have no other relationship with advertisers.</p>

            <h2 class="terms-h2"><strong>DISCLAIMER</strong></h2>

            <p class="mb-3"><span style="font-weight: 600;">THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR
                ...
                BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</span></p>

            <h2 class="terms-h2"><strong>LIMITATION OF LIABILITY</strong></h2>

            <p class="mb-3"><span style="font-weight: 600;">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
            ...
            <h2 class="terms-h2"><strong>INDEMNIFICATION AND RELEASE</strong></h2>

            <p class="mb-3">You hereby agree to indemnify us and hold us harmless from any and all damages and third-party claims and
                expenses, including attorney’s fees, arising from your use of the Website and/or from your breach of
                these Terms.

                In the event that you have a dispute with one of more other users or any third parties, you hereby
                release us, our officers, employees, agents and successors-in-right from claims, demands and damages
                (actual and consequential) of every kind or nature, known and unknown, suspected and unsuspected,
                disclosed and undisclosed, arising out of or in any way related to such disputes and/or the Website.</p>
